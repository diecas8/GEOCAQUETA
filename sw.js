...
const CACHE_NAME   = 'geoportal-aps-v10';
const CACHE_STATIC = 'geoportal-static-v10';
...
self.addEventListener('fetch', event => {
  /* Solo interceptar GET — dejar pasar POST/PUT/DELETE sin caché */
  if (event.request.method !== 'GET') return;

  /* Ignorar blob:, data: y chrome-extension: — no interceptar descargas generadas */
  if (
